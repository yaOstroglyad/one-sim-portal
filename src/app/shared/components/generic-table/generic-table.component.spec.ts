...
describe('GenericTableComponent', () => {
    ...
    describe('selection', () => {
        ...
        it('should select all items when toggleAll is called with checked', () => {
            // Arrange
            const selectionSpy = vi.spyOn(component.selectedItemsChange, 'emit');
    ...
    describe('row actions', () => {
        ...
        it('should emit toggleAction when onEdit is called', () => {
            // Arrange
            const editSpy = vi.spyOn(component.toggleAction, 'emit');
        ...
        it('should emit onRowClickEvent when onRowClick is called', () => {
            // Arrange
            const rowClickSpy = vi.spyOn(component.onRowClickEvent, 'emit');
